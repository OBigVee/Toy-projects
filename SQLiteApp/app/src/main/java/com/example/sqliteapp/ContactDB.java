...
public class ContactDB {
    ...
    {
        // functions helps to open the DB to read or write
    ...
    {
        String [] cols = new String[]{KEY_ROW_ID, KEY_NAME,KEY_CELL};

        Cursor c = ourDatabase.query(DATABASE_TABLE,cols,null,null,null,null,null);
